                ...
                if (sessions) {
                    for (var i = 0; i <= sessions.length; i++) {
                        ...
                        $('#session tbody').append("<tr class=" + classname + "><td>" + sessions[i]
                            .center_id + "</td><td>" + sessions[i].date + "</td><td>" + sessions[i].available_capacity_dose1 + "</td><td>" + sessions[i].available_capacity_dose2 + "</td><td>" +
                            sessions[i].vaccine +  "</td><td>" + sessions[i].name + "</td><td>" + sessions[i].address + "</td><td>" + sessions[i].fee + "</td><td>" + sessions[i].slots + "</td><td>")
                    }
                }
            } else {
                alert('error');
